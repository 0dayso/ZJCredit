...
namespace System.Runtime.Remoting.Messaging
{
  ...
  {
    public static string[] CCMkeys = new string[11]{ "__Uri", "__MethodName", "__MethodSignature", "__TypeName", "__Args", "__CallContext", "__CallSiteActivationAttributes", "__ActivationType", "__ContextProperties", "__Activator", "__ActivationTypeName" };
