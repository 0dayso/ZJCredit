...
namespace System.Security.Util
{
  internal static class XMLUtil
  {
    ...
    public static SecurityElement NewPermissionElement(string name)
    {
      ...
      string name1 = "class";
      string str = name;
      securityElement.AddAttribute(name1, str);
      ...
      if (XMLUtil.ParseElementForObjectCreation(el, "System.Security.Permissions.", out className, out classNameStart, out classNameLength))
      {
        switch (classNameLength)
        {
          ...
          case 16:
            ...
            break;
          case 18:
            if ((int) className[classNameStart] == 82)
            {
          ...
          case 20:
            ...
            break;
          case 21:
            if ((int) className[classNameStart] == 69)
            {
            ...
            if ((int) className[classNameStart] == 85)
            {
            ...
            break;
          case 22:
            if ((int) className[classNameStart] == 83)
            {
            ...
            if ((int) className[classNameStart] == 90)
            {
