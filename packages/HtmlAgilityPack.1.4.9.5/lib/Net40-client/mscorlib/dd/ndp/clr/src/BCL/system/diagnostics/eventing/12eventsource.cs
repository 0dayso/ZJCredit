  ...
  internal class ManifestBuilder
  {
    ...
    public void AddEventParameter(Type type, string name)
    {
      ...
      if (type == typeof (byte[]))
      {
        ...
        this.numParams = this.numParams + 1;
    ...
    public ulong GetChannelKeyword(EventChannel channel)
    {
      ...
      if (!this.channelTab.TryGetValue((int) channel, out channelInfo))
      {
        ...
        this.nextChannelKeywordBit = this.nextChannelKeywordBit >> 1;
      }
      else
    ...
    private void WriteNameAndMessageAttribs(StringBuilder stringBuilder, string elementName, string name)
    {
      ...
      StringBuilder stringBuilder1 = this.sb;
      string elementName1 = elementName;
      string name1 = name;
      this.WriteMessageAttrib(stringBuilder1, elementName1, name1, name1);
    }
    ...
    private void WriteMessageAttrib(StringBuilder stringBuilder, string elementName, string name, string value)
    {
      ...
      {
        string @string = this.resources.GetString(str1, CultureInfo.InvariantCulture);
        if (@string != null)
          value = @string;
      }
      if (value == null)
      ...
      string str2;
      if (this.stringTab.TryGetValue(str1, out str2))
        this.ManifestError(Environment.GetResourceString("EventSource_DuplicateStringKey", (object) str1), true);
      else
    ...
    private string TranslateToManifestConvention(string eventMessage, string evtName)
    {
      ...
      while (i < eventMessage.Length)
      {
        ...
        else
        {
          ...
          {
            string[] strArray = new string[8]{ "&amp;", "&lt;", "&gt;", "&apos;", "&quot;", "%r", "%n", "%t" };
