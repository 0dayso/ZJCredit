...
label_15:
    ...
    private string ParseProtocol(string url)
    {
      ...
      switch (length)
      {
        ...
        default:
          ...
          if ((int) url[length + 1] != 92)
          {
            if (url.Length <= length + 2 || (int) url[length + 1] != 47 || (int) url[length + 2] != 47)
              throw new ArgumentException(Environment.GetResourceString("Argument_InvalidUrl"));
            this.m_protocol = url.Substring(0, length);
            for (int index = 0; index < this.m_protocol.Length; ++index)
            {
              char ch = this.m_protocol[index];
              if (((int) ch < 97 || (int) ch > 122) && ((int) ch < 65 || (int) ch > 90) && (((int) ch < 48 || (int) ch > 57) && ((int) ch != 43 && (int) ch != 46)) && (int) ch != 45)
                throw new ArgumentException(Environment.GetResourceString("Argument_InvalidUrl"));
            }
    ...
    private string ParsePort(string url)
    {
      ...
      string str2;
      if (index != -1 && (int) str1[index] == 58)
      {
        if ((int) str1[index + 1] < 48 || (int) str1[index + 1] > 57)
          throw new ArgumentException(Environment.GetResourceString("Argument_InvalidUrl"));
    ...
    internal static string PreProcessForExtendedPathRemoval(string url, bool isFileUrl)
    {
      ...
      return URLString.PreProcessForExtendedPathRemoval(url, isFileUrl, ref isUncShare);
    }
    ...
    private static string PreProcessForExtendedPathRemoval(string url, bool isFileUrl, ref bool isUncShare)
    {
      ...
      {
        stringBuilder.Remove(startIndex, 4);
        num = indexA + 4;
      }
      else
      {
      ...
      if (isFileUrl)
      {
        int length = 0;
        bool flag = false;
        for (; length < stringBuilder.Length && ((int) stringBuilder[length] == 47 || (int) stringBuilder[length] == 92); ++length)
        {
          if (!flag && (int) stringBuilder[length] == 92)
          {
            flag = true;
            if (length + 1 < stringBuilder.Length && (int) stringBuilder[length + 1] == 92)
              isUncShare = true;
          }
        }
    ...
    public string GetFileName()
    {
      ...
      {
        case -1:
          if (str2.Length != 2 || (int) str2[1] != 58 && (int) str2[1] != 124)
          {
            str2 = "\\\\" + str2;
            break;
          }
          break;
        case 2:
          if (num != 2 || (int) str2[1] == 58 || (int) str2[1] == 124)
            break;
          goto default;
        default:
          str2 = "\\\\" + str2;
    ...
    public string GetDirectoryName()
    {
      ...
      else if (num > 2 || num == 2 && (int) str2[1] != 58 && (int) str2[1] != 124)
        str2 = "\\\\" + str2;
      string str3 = str2 + "\\";
      if (length1 > 0)
