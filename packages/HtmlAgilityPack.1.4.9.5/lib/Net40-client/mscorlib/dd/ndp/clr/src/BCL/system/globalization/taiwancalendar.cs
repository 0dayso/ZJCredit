...
namespace System.Globalization
{
  ...
  {
    internal static EraInfo[] taiwanEraInfo = new EraInfo[1]{ new EraInfo(1, 1912, 1, 1, 1911, 1, 8088) };
    ...
    public TaiwanCalendar()
    {
      ...
      this.helper = new GregorianCalendarHelper((Calendar) this, TaiwanCalendar.taiwanEraInfo);
    }

    internal static Calendar GetDefaultInstance()
    {
      if (TaiwanCalendar.s_defaultInstance == null)
        TaiwanCalendar.s_defaultInstance = (Calendar) new TaiwanCalendar();
