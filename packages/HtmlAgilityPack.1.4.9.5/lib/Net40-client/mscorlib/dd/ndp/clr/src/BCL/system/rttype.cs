  ...
  internal class RuntimeType : System.Reflection.TypeInfo, ISerializable, ICloneable
  {
    ...
    internal static MethodBase GetMethodBase(RuntimeType reflectedType, RuntimeMethodHandleInternal methodHandle)
    {
      ...
      if (reflectedType != declaringType && !reflectedType.IsSubclassOf((Type) declaringType))
      {
        ...
        {
          MethodBase[] methodBaseArray = reflectedType.GetMember(RuntimeMethodHandle.GetName(methodHandle), MemberTypes.Constructor | MemberTypes.Method, BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic) as MethodBase[];
          bool flag = false;
          for (int index = 0; index < methodBaseArray.Length; ++index)
          {
            if (((IRuntimeMethodInfo) methodBaseArray[index]).Value.Value == methodHandle.Value)
              flag = true;
          }
          if (!flag)
        ...
        {
          RuntimeType runtimeType1 = (RuntimeType) declaringType.GetGenericTypeDefinition();
          RuntimeType runtimeType2;
          for (runtimeType2 = reflectedType; runtimeType2 != (RuntimeType) null; runtimeType2 = runtimeType2.GetBaseType())
          {
            ...
            if (runtimeType3 == runtimeType1)
              break;
          }
          if (runtimeType2 == (RuntimeType) null)
            throw new ArgumentException(string.Format((IFormatProvider) CultureInfo.CurrentCulture, Environment.GetResourceString("Argument_ResolveMethodHandle"), (object) reflectedType.ToString(), (object) declaringType.ToString()));
          declaringType = runtimeType2;
    ...
    internal static void ValidateGenericArguments(MemberInfo definition, RuntimeType[] genericArguments, Exception e)
    {
      ...
      else
      {
        ...
        RuntimeType runtimeType = (RuntimeType) runtimeMethodInfo.DeclaringType;
        if (runtimeType != (RuntimeType) null)
        {
          typeHandleInternal = runtimeType.GetTypeHandleInternal();
          runtimeTypeArray1 = typeHandleInternal.GetInstantiationInternal();
        }
      }
      for (int index = 0; index < genericArguments.Length; ++index)
      {
        Type type1 = (Type) genericArguments[index];
        Type type2 = (Type) argumentsInternal[index];
        typeHandleInternal = type2.GetTypeHandleInternal();
        ...
        typeHandleInternal = type1.GetTypeHandleInternal();
        ...
        if (!RuntimeTypeHandle.SatisfiesConstraints(typeChecked1, typeContext, methodContext, typeChecked2))
          throw new ArgumentException(Environment.GetResourceString("Argument_GenConstraintViolation", (object) index.ToString((IFormatProvider) CultureInfo.CurrentCulture), (object) type1.ToString(), (object) definition.ToString(), (object) type2.ToString()), e);
      }
    }
    ...
    private static void FilterHelper(BindingFlags bindingFlags, ref string name, bool allowPrefixLookup, out bool prefixLookup, out bool ignoreCase, out RuntimeType.MemberListType listType)
    {
      ...
      if (name != null)
      {
        if ((bindingFlags & BindingFlags.IgnoreCase) != BindingFlags.Default)
        {
          ...
          string& local = @name;
          // ISSUE: explicit reference operation
          string lower = (^local).ToLower(CultureInfo.InvariantCulture);
          // ISSUE: explicit reference operation
          ^local = lower;
          ignoreCase = true;
        ...
        string& local1 = @name;
        // ISSUE: explicit reference operation
        string str = (^local1).Substring(0, name.Length - 1);
        // ISSUE: explicit reference operation
        ^local1 = str;
        prefixLookup = true;
    ...
    private static bool FilterApplyMethodBase(MethodBase methodBase, BindingFlags methodFlags, BindingFlags bindingFlags, CallingConventions callConv, Type[] argumentTypes)
    {
      ...
      if (argumentTypes != null)
      {
        ...
        if (argumentTypes.Length != parametersNoCopy.Length)
        {
          ...
          if (flag)
          {
            if (parametersNoCopy.Length == 0 || argumentTypes.Length < parametersNoCopy.Length - 1)
              return false;
            ParameterInfo[] parameterInfoArray = parametersNoCopy;
            int index = parameterInfoArray.Length - 1;
        ...
        else if ((bindingFlags & BindingFlags.ExactBinding) != BindingFlags.Default && (bindingFlags & BindingFlags.InvokeMethod) == BindingFlags.Default)
        {
          ...
          {
            if (argumentTypes[index] != null && parametersNoCopy[index].ParameterType != argumentTypes[index])
              return false;
          }
        }
      }
    ...
    public override bool IsAssignableFrom(Type c)
    {
      ...
      if (c == this)
        return true;
      RuntimeType type = c.UnderlyingSystemType as RuntimeType;
    ...
    private void GetGUID(ref Guid result);
    ...
    public override Array GetEnumValues()
    {
      ...
      {
        object @object = Enum.ToObject((Type) this, values[index]);
        instance.SetValue(@object, index);
      }
      return instance;
    }
    ...
    internal object CheckValue(object value, Binder binder, CultureInfo culture, BindingFlags invokeAttr)
    {
      if (this.IsInstanceOfType(value))
      {
        ...
        if ((realProxy == null ? value.GetType() : realProxy.GetProxiedType()) != this && RuntimeTypeHandle.IsValueType(this))
    ...
    public override object InvokeMember(string name, BindingFlags bindingFlags, Binder binder, object target, object[] providedArgs, ParameterModifier[] modifiers, CultureInfo culture, string[] namedParams)
    {
      ...
      bool flag1 = (uint) (bindingFlags & BindingFlags.GetField) > 0U;
      bool flag2 = (uint) (bindingFlags & BindingFlags.SetField) > 0U;
      if (flag1 | flag2)
      {
        if (flag1)
        {
        ...
        if (match.Length == 1)
          ...
          fieldInfo = binder.BindToField(bindingFlags, match, flag1 ? (object) Empty.Value : providedArgs[0], culture);
        if (fieldInfo != (FieldInfo) null)
        {
      ...
      bool flag3 = (uint) (bindingFlags & BindingFlags.GetProperty) > 0U;
      bool flag4 = (uint) (bindingFlags & BindingFlags.SetProperty) > 0U;
      if (flag3 | flag4)
      {
        if (flag3)
        {
      ...
      if ((bindingFlags & BindingFlags.InvokeMethod) != BindingFlags.Default)
      {
        MethodInfo[] methodInfoArray = this.GetMember(name, MemberTypes.Method, bindingFlags) as MethodInfo[];
        List<MethodInfo> methodInfoList = (List<MethodInfo>) null;
        for (int index = 0; index < methodInfoArray.Length; ++index)
        {
          MethodInfo methodInfo2 = methodInfoArray[index];
          if (RuntimeType.FilterApplyMethodInfo((RuntimeMethodInfo) methodInfo2, bindingFlags, CallingConventions.Any, new Type[length1]))
          {
            ...
            else
            {
              ...
              {
                methodInfoList = new List<MethodInfo>(methodInfoArray.Length);
      ...
      if (methodInfo1 == (MethodInfo) null & flag3 | flag4)
      {
        PropertyInfo[] propertyInfoArray = this.GetMember(name, MemberTypes.Property, bindingFlags) as PropertyInfo[];
        List<MethodInfo> methodInfoList = (List<MethodInfo>) null;
        for (int index = 0; index < propertyInfoArray.Length; ++index)
        {
          MethodInfo methodInfo2 = !flag4 ? propertyInfoArray[index].GetGetMethod(true) : propertyInfoArray[index].GetSetMethod(true);
          if (!(methodInfo2 == (MethodInfo) null) && RuntimeType.FilterApplyMethodInfo((RuntimeMethodInfo) methodInfo2, bindingFlags, CallingConventions.Any, new Type[length1]))
          {
            ...
            else
            {
              if (methodInfoList == null)
              {
                methodInfoList = new List<MethodInfo>(propertyInfoArray.Length);
                methodInfoList.Add(methodInfo1);
              }
              methodInfoList.Add(methodInfo2);
            }
    ...
    private object ForwardCallToInvokeMember(string memberName, BindingFlags flags, object target, int[] aWrapperTypes, ref MessageData msgData)
    {
      ...
      for (int index = 0; index < length; ++index)
      {
        if (modifiers[0][index] && args[index] != null)
        {
          ...
          if (elementType != args[index].GetType())
      ...
      for (int index1 = 0; index1 < length1; ++index1)
      {
        if (aWrapperTypes[index1] != 0)
        {
          if ((aWrapperTypes[index1] & 65536) != 0)
          {
            ...
            Array array = (Array) aArgs[index1];
            int length2 = array.Length;
            object[] objArray = (object[]) Array.UnsafeCreateInstance(elementType, length2);
            ConstructorInfo constructor;
            if (flag)
              constructor = elementType.GetConstructor(new Type[1]{ typeof (string) });
            else
              constructor = elementType.GetConstructor(new Type[1]{ typeof (object) });
            for (int index2 = 0; index2 < length2; ++index2)
            {
              if (flag)
                objArray[index2] = constructor.Invoke(new object[1]
                {
                  (object) (string) array.GetValue(index2)
                });
              else
                objArray[index2] = constructor.Invoke(new object[1]
                {
                  array.GetValue(index2)
                });
            }
            aArgs[index1] = (object) objArray;
          }
          else
          {
    ...
    internal class RuntimeTypeCache
    {
      ...
      internal RuntimeType GetEnclosingType()
      {
        if (this.m_enclosingType == (RuntimeType) null)
          this.m_enclosingType = RuntimeTypeHandle.GetDeclaringType(this.GetRuntimeType()) ?? (RuntimeType) typeof (void);
      ...
      internal string GetDefaultMemberName()
      {
        if (this.m_defaultMemberName == null)
        {
          ...
          for (RuntimeType runtimeType = this.m_runtimeType; runtimeType != (RuntimeType) null; runtimeType = runtimeType.GetBaseType())
          {
            ...
            {
              if (customAttributes[index].Constructor.DeclaringType == type)
              {
      ...
      internal MethodInfo GetGenericMethodInfo(RuntimeMethodHandleInternal genericMethod)
      {
        ...
        RuntimeMethodInfo index1 = new RuntimeMethodInfo(genericMethod, RuntimeMethodHandle.GetDeclaringType(genericMethod), this, RuntimeMethodHandle.GetAttributes(genericMethod), ~BindingFlags.Default, (object) loaderAllocator);
        RuntimeMethodInfo runtimeMethodInfo1 = loaderAllocator == null ? RuntimeType.RuntimeTypeCache.s_methodInstantiations[index1] : loaderAllocator.m_methodInstantiations[index1];
        if ((MethodInfo) runtimeMethodInfo1 != (MethodInfo) null)
          return (MethodInfo) runtimeMethodInfo1;
        ...
        try
        {
          ...
          {
            RuntimeMethodInfo runtimeMethodInfo2 = loaderAllocator.m_methodInstantiations[index1];
            if ((MethodInfo) runtimeMethodInfo2 != (MethodInfo) null)
              return (MethodInfo) runtimeMethodInfo2;
            RuntimeMethodInfo index2;
            loaderAllocator.m_methodInstantiations[index2] = index2 = index1;
          }
          else
          {
            RuntimeMethodInfo runtimeMethodInfo2 = RuntimeType.RuntimeTypeCache.s_methodInstantiations[index1];
            if ((MethodInfo) runtimeMethodInfo2 != (MethodInfo) null)
              return (MethodInfo) runtimeMethodInfo2;
            RuntimeMethodInfo index2;
            RuntimeType.RuntimeTypeCache.s_methodInstantiations[index2] = index2 = index1;
          }
        }
        finally
        {
      ...
      private class MemberInfoCache<T> where T : MemberInfo
      {
        ...
        internal MethodBase AddMethod(RuntimeType declaringType, RuntimeMethodHandleInternal method, RuntimeType.RuntimeTypeCache.CacheType cacheType)
        {
          ...
          int num1 = (attributes & MethodAttributes.MemberAccessMask) == MethodAttributes.Public ? 1 : 0;
          bool flag = (uint) (attributes & MethodAttributes.Static) > 0U;
          int num2 = declaringType != this.ReflectedType ? 1 : 0;
          int num3 = flag ? 1 : 0;
          BindingFlags bindingFlags = RuntimeType.FilterPreCalculate(num1 != 0, num2 != 0, num3 != 0);
        ...
        {
          int num1 = (int) RuntimeFieldHandle.GetAttributes(field);
          int num2 = 7;
          bool isPublic = (num1 & num2) == 6;
          int num3 = 16;
          bool isStatic = (uint) (num1 & num3) > 0U;
          ...
          T[] list = (T[]) new RuntimeFieldInfo[1]{ (RuntimeFieldInfo) new RtFieldInfo(field, this.ReflectedType, this.m_runtimeTypeCache, bindingFlags) };
          this.Insert(ref list, (string) null, RuntimeType.MemberListType.HandleToInfo);
          ...
          try
          {
            ...
            switch (listType)
            {
              ...
              case RuntimeType.MemberListType.CaseSensitive:
                T[] objArray1 = this.m_csMemberInfos[name];
                if (objArray1 == null)
                {
                  this.MergeWithGlobalList(list);
              ...
              case RuntimeType.MemberListType.CaseInsensitive:
                T[] objArray2 = this.m_cisMemberInfos[name];
                if (objArray2 == null)
                {
                  this.MergeWithGlobalList(list);
                ...
                if (!filter.RequiresStringComparison() || RuntimeMethodHandle.MatchesNameHash(introducedMethod, filter.GetHashToMatch()) && filter.Match(RuntimeMethodHandle.GetUtf8Name(introducedMethod)))
                {
                  ...
                  if ((attributes & MethodAttributes.RTSpecialName) == MethodAttributes.PrivateScope)
                  {
                    ...
                    if (flag1)
                    {
                      ...
                      continue;
                    int num1 = methodAttributes == MethodAttributes.Public ? 1 : 0;
                    bool flag4 = (uint) (attributes & MethodAttributes.Static) > 0U;
                    int num2 = flag2 ? 1 : 0;
                    int num3 = flag4 ? 1 : 0;
                    BindingFlags bindingFlags = RuntimeType.FilterPreCalculate(num1 != 0, num2 != 0, num3 != 0);
                    RuntimeMethodInfo runtimeMethodInfo = new RuntimeMethodInfo(RuntimeMethodHandle.GetStubIfNeeded(introducedMethod, runtimeType, (RuntimeType[]) null), runtimeType, this.m_runtimeTypeCache, attributes, bindingFlags, (object) null);
        ...
        {
          bool flag1 = RuntimeTypeHandle.HasInstantiation(declaringType) && !RuntimeTypeHandle.ContainsGenericVariables(declaringType);
          ...
          for (int index = 0; index < count; ++index)
          {
            ...
            if (!filter.RequiresStringComparison() || RuntimeFieldHandle.MatchesNameHash(fieldHandleInternal, filter.GetHashToMatch()) && filter.Match(RuntimeFieldHandle.GetUtf8Name(fieldHandleInternal)))
            {
              ...
              {
                int num1 = fieldAttributes == FieldAttributes.Public ? 1 : 0;
                bool flag3 = (uint) (attributes & FieldAttributes.Static) > 0U;
                int num2 = flag2 ? 1 : 0;
                int num3 = flag3 ? 1 : 0;
                BindingFlags bindingFlags = RuntimeType.FilterPreCalculate(num1 != 0, num2 != 0, num3 != 0);
                if (flag1 & flag3)
        ...
        private void PopulateLiteralFields(RuntimeType.RuntimeTypeCache.Filter filter, RuntimeType declaringType, ref RuntimeType.ListBuilder<RuntimeFieldInfo> list)
        {
          ...
          {
            int num1 = result[index];
            FieldAttributes fieldAttributes1;
            metadataImport.GetFieldDefProps(num1, out fieldAttributes1);
            ...
            {
              bool flag1 = declaringType != this.ReflectedType;
              if (!flag1 || fieldAttributes2 != FieldAttributes.Private)
              {
                if (filter.RequiresStringComparison())
                {
                  Utf8String name = metadataImport.GetName(num1);
                  if (!filter.Match(name))
                    continue;
                }
                int num2 = fieldAttributes2 == FieldAttributes.Public ? 1 : 0;
                bool flag2 = (uint) (fieldAttributes1 & FieldAttributes.Static) > 0U;
                int num3 = flag1 ? 1 : 0;
                int num4 = flag2 ? 1 : 0;
                BindingFlags bindingFlags = RuntimeType.FilterPreCalculate(num2 != 0, num3 != 0, num4 != 0);
                RuntimeFieldInfo runtimeFieldInfo = (RuntimeFieldInfo) new MdFieldInfo(num1, fieldAttributes1, declaringType.GetTypeHandleInternal(), this.m_runtimeTypeCache, bindingFlags);
                list.Add(runtimeFieldInfo);
              }
            }
          }
        ...
        private void AddSpecialInterface(ref RuntimeType.ListBuilder<RuntimeType> list, RuntimeType.RuntimeTypeCache.Filter filter, RuntimeType iList, bool addSubInterface)
        {
          ...
          if (!addSubInterface)
            return;
          foreach (RuntimeType @interface in iList.GetInterfaces())
          {
            if (@interface.IsGenericType && filter.Match(RuntimeTypeHandle.GetUtf8Name(@interface)))
              list.Add(@interface);
          }
        }
        ...
        private RuntimeType[] PopulateInterfaces(RuntimeType.RuntimeTypeCache.Filter filter)
        {
          ...
          if (!RuntimeTypeHandle.IsGenericVariable(reflectedType))
          {
            ...
            {
              RuntimeType runtimeType = (RuntimeType) this.ReflectedType.GetElementType();
              if (!runtimeType.IsPointer)
              {
                this.AddSpecialInterface(ref list, filter, (RuntimeType) typeof (IList<>).MakeGenericType((Type) runtimeType), 1 != 0);
                this.AddSpecialInterface(ref list, filter, (RuntimeType) typeof (IReadOnlyList<>).MakeGenericType((Type) runtimeType), 0 != 0);
                this.AddSpecialInterface(ref list, filter, (RuntimeType) typeof (IReadOnlyCollection<>).MakeGenericType((Type) runtimeType), 0 != 0);
              }
            }
          }
          else
          {
            ...
            foreach (RuntimeType parameterConstraint in reflectedType.GetGenericParameterConstraints())
            {
              ...
              foreach (Type @interface in parameterConstraint.GetInterfaces())
                runtimeTypeList.Add(@interface as RuntimeType);
            }
            Dictionary<RuntimeType, RuntimeType> dictionary = new Dictionary<RuntimeType, RuntimeType>();
            for (int index1 = 0; index1 < runtimeTypeList.Count; ++index1)
            {
              RuntimeType key = runtimeTypeList[index1];
              if (!dictionary.ContainsKey(key))
              {
                RuntimeType index2;
                dictionary[index2] = index2 = key;
              }
            }
    ...
    private class ActivatorCache
    {
      ...
      private void InitializeCacheEntry(RuntimeType.ActivatorCacheEntry ace)
      {
        if (!ace.m_type.IsValueType)
        {
          ...
          CtorDelegate ctorDelegate = (CtorDelegate) this.delegateCtorInfo.Invoke(new object[2]{ null, (object) RuntimeMethodHandle.GetFunctionPointer(ace.m_hCtorMethodHandle) });
