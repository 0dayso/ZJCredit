...
{
  /// <summary>请改用 <see cref="T:System.Runtime.InteropServices.ComTypes.IEnumMoniker" />。</summary>
  ...
  public interface UCOMIEnumMoniker
  {
    ...
    /// <param name="rgelt">成功返回时，是对枚举名字对象的引用。</param>
    /// <param name="pceltFetched">成功返回时，是对在 <paramref name="rgelt" /> 中枚举的名字对象的实际数目的引用。</param>
    [MethodImpl(MethodImplOptions.PreserveSig)]
    int Next(int celt, [MarshalAs(UnmanagedType.LPArray), Out] UCOMIMoniker[] rgelt, out int pceltFetched);
