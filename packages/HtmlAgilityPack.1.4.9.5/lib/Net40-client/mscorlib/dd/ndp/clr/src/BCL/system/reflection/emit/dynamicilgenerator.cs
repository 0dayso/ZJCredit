...
namespace System.Reflection.Emit
{
  internal class DynamicILGenerator : ILGenerator
  {
    ...
    public override void BeginCatchBlock(Type exceptionType)
    {
      ...
      __ExceptionInfo exceptionInfo = this.CurrExcStack[this.CurrExcStackCount - 1];
      ...
      exceptionInfo.MarkCatchAddr(this.ILOffset, exceptionType);
      exceptionInfo.m_filterAddr[exceptionInfo.m_currentCatch - 1] = this.GetTokenFor(rtType);
    }
