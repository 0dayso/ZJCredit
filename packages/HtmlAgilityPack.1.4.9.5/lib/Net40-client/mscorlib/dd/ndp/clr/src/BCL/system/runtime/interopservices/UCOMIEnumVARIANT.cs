...
{
  /// <summary>请改用 <see cref="T:System.Runtime.InteropServices.ComTypes.IEnumVARIANT" />。</summary>
  ...
  public interface UCOMIEnumVARIANT
  {
    ...
    /// <param name="rgvar">成功返回时，是对枚举元素的引用。</param>
    /// <param name="pceltFetched">成功返回时，是对在 <paramref name="rgelt" /> 中枚举的元素的实际数目的引用。</param>
