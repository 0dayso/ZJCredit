...
namespace System
{
  ...
  public struct UInt64 : IComparable, IFormattable, IConvertible, IComparable<ulong>, IEquatable<ulong>
  {
    ...
    public override bool Equals(object obj)
    {
      if (!(obj is ulong))
        return false;
      return (long) this == (long) (ulong) obj;
    }
    ...
    {
      return Number.FormatUInt64(this, (string) null, NumberFormatInfo.CurrentInfo);
    }
    ...
    {
      return Number.FormatUInt64(this, (string) null, NumberFormatInfo.GetInstance(provider));
    }
    ...
    {
      throw new InvalidCastException(Environment.GetResourceString("InvalidCast_FromTo", (object) "UInt64", (object) "DateTime"));
    }
