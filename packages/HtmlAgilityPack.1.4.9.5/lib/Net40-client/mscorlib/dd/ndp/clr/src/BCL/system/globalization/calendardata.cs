...
namespace System.Globalization
{
  internal class CalendarData
  {
    ...
    static CalendarData()
    {
      ...
      calendarData1.saYearMonths = new string[1]{ "yyyy MMMM" };
      calendarData1.sMonthDay = "MMMM dd";
      calendarData1.saEraNames = new string[1]{ "A.D." };
      calendarData1.saAbbrevEraNames = new string[1]{ "AD" };
      calendarData1.saAbbrevEnglishEraNames = new string[1]{ "AD" };
