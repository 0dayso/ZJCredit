  ...
  internal sealed class ObjectHolder
  {
    ...
    internal bool ValueTypeFixupPerformed
    {
      ...
      set
      {
        if (!value)
          return;
        this.m_flags = this.m_flags | 32768;
      }
    }
    ...
    internal bool RequiresSerInfoFixup
    {
      ...
      {
        if (!value)
          this.m_flags = this.m_flags | 16384;
        else
          this.m_flags = this.m_flags & -16385;
      }
    }
    ...
    {
      this.m_missingDecendents = this.m_missingDecendents + amount;
    }

    internal void DecrementFixupsRemaining(ObjectManager manager)
    {
      this.m_missingElementsRemaining = this.m_missingElementsRemaining - 1;
