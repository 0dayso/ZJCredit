  ...
  internal static class RemotingConfigHandler
  {
    ...
    private static void LoadMachineConfigIfNecessary()
    {
      ...
      lock (RemotingConfigHandler.Info)
      {
        if (RemotingConfigHandler._bMachineConfigLoaded)
          return;
        RemotingXmlConfigFileData local_2 = RemotingXmlConfigFileParser.ParseDefaultConfiguration();
        if (local_2 != null)
          RemotingConfigHandler.ConfigureRemoting(local_2, false);
        string local_3 = Config.MachineDirectory + "machine.config";
        new FileIOPermission(FileIOPermissionAccess.Read, local_3).Assert();
        RemotingXmlConfigFileData local_2_1 = RemotingConfigHandler.LoadConfigurationFromXmlFile(local_3);
        if (local_2_1 != null)
          RemotingConfigHandler.ConfigureRemoting(local_2_1, false);
    ...
    private static RemotingXmlConfigFileData LoadConfigurationFromXmlFile(string filename)
    {
      ...
      catch (Exception ex)
      {
        ...
        Exception exception2 = (Exception) (exception1.InnerException as FileNotFoundException);
        if (exception2 != null)
          exception1 = exception2;
        throw new RemotingException(string.Format((IFormatProvider) CultureInfo.CurrentCulture, Environment.GetResourceString("Remoting_Config_ReadFailure"), (object) filename, (object) exception1));
      }
    }
    ...
    private static void ConfigureRemoting(RemotingXmlConfigFileData configData, bool ensureSecurity)
    {
      try
      {
        string str = configData.ApplicationName;
        if (str != null)
          RemotingConfigHandler.ApplicationName = str;
    ...
    private static object CreateChannelSinkProvider(RemotingXmlConfigFileData.SinkProviderEntry entry, bool bServer)
    {
      ...
      object[] args = new object[2]{ (object) entry.Properties, (object) entry.ProviderData };
      try
      {
    ...
    private static void ParseGenericType(string typeAssem, int indexStart, out string typeName, out string assemName)
    {
      ...
      {
        if ((int) typeAssem[startIndex] == 91)
          ++num;
        else if ((int) typeAssem[startIndex] == 93)
          --num;
      }
    ...
    internal class RemotingConfigInfo
    {
      ...
      private static IContextAttribute[] CreateContextAttributesFromConfigEntries(ArrayList contextAttributes)
      {
        ...
        int num = 0;
        foreach (RemotingXmlConfigFileData.ContextAttributeEntry contextAttribute1 in contextAttributes)
        {
          Assembly assembly = Assembly.Load(contextAttribute1.AssemblyName);
          Hashtable hashtable = contextAttribute1.Properties;
          IContextAttribute contextAttribute2;
          if (hashtable != null && hashtable.Count > 0)
          {
            object[] args = new object[1]{ (object) hashtable };
            contextAttribute2 = (IContextAttribute) Activator.CreateInstance(assembly.GetType(contextAttribute1.TypeName, false, false), BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.CreateInstance, (Binder) null, args, (CultureInfo) null, (object[]) null);
          }
          else
            contextAttribute2 = (IContextAttribute) Activator.CreateInstance(assembly.GetType(contextAttribute1.TypeName, false, false), true);
          contextAttributeArray[num++] = contextAttribute2;
        }
        ...
        foreach (DictionaryEntry dictionaryEntry in this._wellKnownExportInfo)
        {
          ...
          if (typeName == serviceTypeEntry.TypeName)
          {
            ...
            if (asmName == serviceTypeEntry.AssemblyName)
              flag = true;
            else if (string.Compare(serviceTypeEntry.AssemblyName, 0, asmName, 0, asmName.Length, StringComparison.OrdinalIgnoreCase) == 0 && (int) serviceTypeEntry.AssemblyName[asmName.Length] == 44)
              flag = true;
            if (flag)
              return true;
          }
      ...
      internal void AddActivatedClientType(ActivatedClientTypeEntry entry)
      {
        ...
        if (entry1 == null)
        {
          ...
          entry1 = new RemoteAppEntry(str, str);
      ...
      internal ServerIdentity StartupWellKnownObject(string asmName, string svrTypeName, string URI, WellKnownObjectMode mode, bool fReplace)
      {
        ...
        {
          Type local_4 = RemotingConfigHandler.RemotingConfigInfo.LoadType(svrTypeName, asmName);
          if (!local_4.IsMarshalByRef)
            throw new RemotingException(Environment.GetResourceString("Remoting_WellKnown_MustBeMBR", (object) svrTypeName));
          ServerIdentity local_3_1 = (ServerIdentity) IdentityHolder.ResolveIdentity(URI);
          if (local_3_1 != null && local_3_1.IsRemoteDisconnected())
          {
            IdentityHolder.RemoveIdentity(URI);
            local_3_1 = (ServerIdentity) null;
          }
          if (local_3_1 == null)
          {
            ...
            try
            {
              MarshalByRefObject local_2_1 = (MarshalByRefObject) Activator.CreateInstance(local_4, true);
              if (RemotingServices.IsClientProxy((object) local_2_1))
              {
                RedirectionProxy temp_69 = new RedirectionProxy(local_2_1, local_4);
                temp_69.ObjectMode = mode;
                string temp_71 = URI;
                Type temp_72 = local_4;
                int temp_73 = 1;
                int temp_74 = 1;
                RemotingServices.MarshalInternal((MarshalByRefObject) temp_69, temp_71, temp_72, temp_73 != 0, temp_74 != 0);
                local_3_1 = (ServerIdentity) IdentityHolder.ResolveIdentity(URI);
                local_3_1.SetSingletonObjectMode();
              }
              else if (local_4.IsCOMObject && mode == WellKnownObjectMode.Singleton)
              {
                RemotingServices.MarshalInternal((MarshalByRefObject) new ComRedirectionProxy(local_2_1, local_4), URI, local_4, true, true);
                local_3_1 = (ServerIdentity) IdentityHolder.ResolveIdentity(URI);
                local_3_1.SetSingletonObjectMode();
              }
              else
              {
                if (RemotingServices.GetObjectUri(local_2_1) != null)
                ...
                RemotingServices.MarshalInternal(local_2_1, URI, local_4, true, true);
                local_3_1 = (ServerIdentity) IdentityHolder.ResolveIdentity(URI);
                if (mode == WellKnownObjectMode.SingleCall)
                  local_3_1.SetSingleCallObjectMode();
                else
                  local_3_1.SetSingletonObjectMode();
              }
            }
            ...
            {
              if (local_3_1 != null)
                local_3_1.IsInitializing = false;
