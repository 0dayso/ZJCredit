  ...
  internal class RuntimeModule : Module
  {
    ...
    public override byte[] ResolveSignature(int metadataToken)
    {
      ...
      if (!metadataToken1.IsMemberRef && !metadataToken1.IsMethodDef && (!metadataToken1.IsTypeSpec && !metadataToken1.IsSignature) && !metadataToken1.IsFieldDef)
        throw new ArgumentException(Environment.GetResourceString("Argument_InvalidToken", (object) metadataToken1, (object) this), "metadataToken");
    ...
    private FieldInfo ResolveLiteralField(int metadataToken, Type[] genericTypeArguments, Type[] genericMethodArguments)
    {
      ...
      if (!this.MetadataImport.IsValidToken((int) metadataToken1) || !metadataToken1.IsFieldDef)
        throw new ArgumentOutOfRangeException("metadataToken", string.Format((IFormatProvider) CultureInfo.CurrentUICulture, Environment.GetResourceString("Argument_InvalidToken", (object) metadataToken1, (object) this), Array.Empty<object>()));
      string @string = this.MetadataImport.GetName((int) metadataToken1).ToString();
      ...
      try
      {
        return type.GetField(@string, BindingFlags.DeclaredOnly | BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
      }
      catch
      {
        throw new ArgumentException(Environment.GetResourceString("Argument_ResolveField", (object) metadataToken1, (object) this), "metadataToken");
      }
    }
