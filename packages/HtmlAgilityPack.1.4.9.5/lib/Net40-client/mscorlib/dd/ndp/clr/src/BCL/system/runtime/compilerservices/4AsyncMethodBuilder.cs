  ...
  internal struct AsyncMethodBuilderCore
  {
    ...
    internal static void ThrowAsync(Exception exception, SynchronizationContext targetContext)
    {
      ...
      if (WindowsRuntimeMarshal.ReportUnhandledError(exceptionDispatchInfo1.SourceException))
        return;
      ExceptionDispatchInfo exceptionDispatchInfo3 = exceptionDispatchInfo1;
      ThreadPool.QueueUserWorkItem((WaitCallback) (state => ((ExceptionDispatchInfo) state).Throw()), (object) exceptionDispatchInfo3);
    }
