...
namespace System
{
  internal static class ThrowHelper
  {
    ...
    {
      throw new ArgumentException(Environment.GetResourceString("Arg_WrongType", key, (object) targetType), "key");
    }

    internal static void ThrowWrongValueTypeArgumentException(object value, Type targetType)
    {
      throw new ArgumentException(Environment.GetResourceString("Arg_WrongType", value, (object) targetType), "value");
    }
