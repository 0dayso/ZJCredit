  ...
  internal sealed class TplEtwProvider : EventSource
  {
    ...
    public void SetActivityId(Guid NewId)
    {
      if (!this.DebugActivityId)
        return;
      this.WriteEvent(25, new object[1]
      {
        (object) NewId
      });
    }
    ...
    internal static Guid CreateGuidForTaskID(int taskID)
    {
      ...
      return new Guid(taskID, (short) domainId, (short) (domainId >> 16), (byte) num, (byte) (num >> 8), (byte) (num >> 16), (byte) (num >> 24), byte.MaxValue, (byte) 220, (byte) 215, (byte) 181);
    }
