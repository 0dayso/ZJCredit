...
namespace Microsoft.Win32
{
  ...
  internal static class Win32Native
  {
    ...
    internal static string GetMessage(int errorCode)
    {
      ...
      int dwLanguageId = 0;
      StringBuilder lpBuffer = sb;
      int capacity = lpBuffer.Capacity;
      IntPtr va_list_arguments = IntPtr.Zero;
      if (Win32Native.FormatMessage(dwFlags, lpSource, dwMessageId, dwLanguageId, lpBuffer, capacity, va_list_arguments) != 0)
        return StringBuilderCache.GetStringAndRelease(sb);
      StringBuilderCache.Release(sb);
      return Environment.GetResourceString("UnknownError_Num", (object) errorCode);
    }
    ...
    internal static bool GlobalMemoryStatusEx(ref Win32Native.MEMORYSTATUSEX buffer)
    {
      ...
      return Win32Native.GlobalMemoryStatusExNative(out buffer);
    }
    ...
    [DllImport("kernel32.dll", SetLastError = true)]
    internal static extern unsafe UIntPtr VirtualQuery(void* address, ref Win32Native.MEMORY_BASIC_INFORMATION buffer, UIntPtr sizeOfBuffer);
    ...
    [DllImport("kernel32.dll", SetLastError = true)]
    internal static extern unsafe bool CancelIoEx(SafeFileHandle handle, NativeOverlapped* lpOverlapped);
    ...
    [DllImport("kernel32.dll", SetLastError = true)]
    internal static extern unsafe bool SetFileTime(SafeFileHandle hFile, Win32Native.FILE_TIME* creationTime, Win32Native.FILE_TIME* lastAccessTime, Win32Native.FILE_TIME* lastWriteTime);
    ...
    [DllImport("kernel32.dll", SetLastError = true)]
    internal static extern unsafe bool SetConsoleWindowInfo(IntPtr hConsoleOutput, bool absolute, Win32Native.SMALL_RECT* consoleWindow);
    ...
    [DllImport("kernel32.dll", SetLastError = true)]
    internal static extern unsafe bool ReadConsoleOutput(IntPtr hConsoleOutput, Win32Native.CHAR_INFO* pBuffer, Win32Native.COORD bufferSize, Win32Native.COORD bufferCoord, ref Win32Native.SMALL_RECT readRegion);

    [DllImport("kernel32.dll", CharSet = CharSet.Unicode, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    internal static extern unsafe bool ReadConsoleW(SafeFileHandle hConsoleInput, byte* lpBuffer, int nNumberOfCharsToRead, out int lpNumberOfCharsRead, IntPtr pInputControl);

    [DllImport("kernel32.dll", SetLastError = true)]
    internal static extern unsafe bool WriteConsoleOutput(IntPtr hConsoleOutput, Win32Native.CHAR_INFO* buffer, Win32Native.COORD bufferSize, Win32Native.COORD bufferCoord, ref Win32Native.SMALL_RECT writeRegion);

    [DllImport("kernel32.dll", CharSet = CharSet.Unicode, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    internal static extern unsafe bool WriteConsoleW(SafeFileHandle hConsoleOutput, byte* lpBuffer, int nNumberOfCharsToWrite, out int lpNumberOfCharsWritten, IntPtr lpReservedMustBeNull);
    ...
    [DllImport("advapi32.dll", CharSet = CharSet.Auto, BestFitMapping = false)]
    internal static extern unsafe int RegEnumKeyEx(SafeRegistryHandle hKey, int dwIndex, char* lpName, ref int lpcbName, int[] lpReserved, [Out] StringBuilder lpClass, int[] lpcbClass, long[] lpftLastWriteTime);

    [DllImport("advapi32.dll", CharSet = CharSet.Auto, BestFitMapping = false)]
    internal static extern unsafe int RegEnumValue(SafeRegistryHandle hKey, int dwIndex, char* lpValueName, ref int lpcbValueName, IntPtr lpReserved_MustBeZero, int[] lpType, byte[] lpData, int[] lpcbData);
