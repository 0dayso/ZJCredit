...
namespace System.Security.Cryptography.X509Certificates
{
  internal static class X509Utils
  {
    ...
    {
      if ((keyStorageFlags & ~(X509KeyStorageFlags.UserKeySet | X509KeyStorageFlags.MachineKeySet | X509KeyStorageFlags.Exportable | X509KeyStorageFlags.UserProtected | X509KeyStorageFlags.PersistKeySet)) != X509KeyStorageFlags.DefaultKeySet)
