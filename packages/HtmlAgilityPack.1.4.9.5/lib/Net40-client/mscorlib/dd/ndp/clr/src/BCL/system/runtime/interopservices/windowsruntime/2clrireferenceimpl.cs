  ...
  internal static class IReferenceFactory
  {
    ...
    internal static object CreateIReference(object obj)
    {
      ...
      if (!nullable.HasValue)
        return (object) null;
      return Activator.CreateInstance(typeof (CLRIReferenceImpl<>).MakeGenericType(type), new object[2]{ (object) nullable.Value, obj });
    }
    ...
    internal static object CreateIReferenceArray(Array obj)
    {
      ...
      return Activator.CreateInstance(typeof (CLRIReferenceArrayImpl<>).MakeGenericType(elementType), new object[2]{ (object) nullable.Value, (object) obj });
    }
  }
}
