  ...
  internal struct EventDescriptor
  {
    ...
    public EventDescriptor(int id, byte version, byte channel, byte level, byte opcode, int task, long keywords)
    {
      ...
      if (id > (int) ushort.MaxValue)
        throw new ArgumentOutOfRangeException("id", Environment.GetResourceString("ArgumentOutOfRange_NeedValidId", (object) 1, (object) ushort.MaxValue));
      ...
      if (task > (int) ushort.MaxValue)
        throw new ArgumentOutOfRangeException("task", Environment.GetResourceString("ArgumentOutOfRange_NeedValidId", (object) 1, (object) ushort.MaxValue));
