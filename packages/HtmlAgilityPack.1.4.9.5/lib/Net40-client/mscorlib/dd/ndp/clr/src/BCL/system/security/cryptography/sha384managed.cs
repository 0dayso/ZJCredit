...
namespace System.Security.Cryptography
{
  ...
  public class SHA384Managed : SHA384
  {
    ...
    /// <summary>当在派生类中重写时，将写入对象的数据路由到 <see cref="T:System.Security.Cryptography.SHA384Managed" /> 哈希算法以计算哈希值。</summary>
    ...
    private static unsafe void SHA384Expand(ulong* x)
    {
      for (int index = 16; index < 80; ++index)
        x[index] = SHA384Managed.sigma_1(x[index - 2]) + x[index - 7] + SHA384Managed.sigma_0(x[index - 15]) + x[index - 16];
    }
  }
}
