...
namespace System.Reflection.Emit
{
  internal class DynamicResolver : Resolver
  {
    ...
    ~DynamicResolver()
    {
      DynamicMethod dynamicMethod = this.m_method;
      if ((MethodInfo) dynamicMethod == (MethodInfo) null || dynamicMethod.m_methodHandle == null)
        return;
      ...
      destroyScout.m_methodHandle = dynamicMethod.m_methodHandle.Value;
    }
    ...
    internal override RuntimeType GetJitContext(ref int securityControlFlags)
    {
      ...
      RuntimeType runtimeType = this.m_method.m_typeOwner;
