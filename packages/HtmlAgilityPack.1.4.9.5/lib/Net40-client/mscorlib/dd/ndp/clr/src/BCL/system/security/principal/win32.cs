...
namespace System.Security.Principal
{
  internal static class Win32
  {
    ...
    internal static SafeLsaPolicyHandle LsaOpenPolicy(string systemName, PolicyRights rights)
    {
      ...
      uint num;
      if ((int) (num = Win32Native.LsaOpenPolicy(systemName, ref attributes, (int) rights, out handle)) == 0)
        return handle;
      if ((int) num == -1073741790)
        throw new UnauthorizedAccessException();
      if ((int) num == -1073741670 || (int) num == -1073741801)
    ...
    internal static byte[] ConvertIntPtrSidToByteArraySid(IntPtr binaryForm)
    {
      ...
      if ((int) num < 0 || (int) num > (int) SecurityIdentifier.MaxSubAuthorities)
...
label_6:
    ...
    internal static int CreateWellKnownSid(WellKnownSidType sidType, SecurityIdentifier domainSid, out byte[] resultSid)
    {
      ...
      resultSid = new byte[(int) resultSidLength];
      if (Win32Native.CreateWellKnownSid((int) sidType, domainSid == (SecurityIdentifier) null ? (byte[]) null : domainSid.BinaryForm, resultSid, ref resultSidLength) != 0)
        return 0;
      resultSid = (byte[]) null;
    ...
    internal static int GetWindowsAccountDomainSid(SecurityIdentifier sid, out SecurityIdentifier resultSid)
    {
      ...
      uint resultSidLength = (uint) SecurityIdentifier.MaxBinaryLength;
      byte[] numArray2 = new byte[(int) resultSidLength];
      if (Win32Native.GetWindowsAccountDomainSid(numArray1, numArray2, ref resultSidLength) != 0)
      {
