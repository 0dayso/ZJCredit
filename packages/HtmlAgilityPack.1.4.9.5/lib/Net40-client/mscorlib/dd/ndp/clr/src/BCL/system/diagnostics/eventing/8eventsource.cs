...
namespace System.Diagnostics.Tracing
{
  internal sealed class ActivityFilter : IDisposable
  {
    ...
    public static void UpdateKwdTriggers(ActivityFilter activityFilter, Guid sourceGuid, EventSource source, EventKeywords sessKeywords)
    {
      ...
      {
        if (sourceGuid == activityFilter1.m_providerGuid && ((int) source.m_eventData[activityFilter1.m_eventId].TriggersActivityTracking > 0 || (int) source.m_eventData[activityFilter1.m_eventId].Descriptor.Opcode == 9))
