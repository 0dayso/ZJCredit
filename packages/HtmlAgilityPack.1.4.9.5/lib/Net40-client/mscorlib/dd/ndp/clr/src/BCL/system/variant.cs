...
namespace System
{
  ...
  {
    internal static readonly Type[] ClassTypes = new Type[23]{ typeof (System.Empty), typeof (void), typeof (bool), typeof (char), typeof (sbyte), typeof (byte), typeof (short), typeof (ushort), typeof (int), typeof (uint), typeof (long), typeof (ulong), typeof (float), typeof (double), typeof (string), typeof (void), typeof (DateTime), typeof (TimeSpan), typeof (object), typeof (Decimal), typeof (object), typeof (System.Reflection.Missing), typeof (System.DBNull) };
    ...
    public Variant(DateTime val)
    {
      this.m_objref = (object) null;
      this.m_flags = 16;
      ulong num = (ulong) val.Ticks;
      this.m_data1 = (int) num;
      this.m_data2 = (int) (num >> 32);
    }
    ...
    public Variant(object obj)
    {
      ...
      if (obj is DateTime)
      {
        this.m_objref = (object) null;
        this.m_flags = 16;
        ulong num = (ulong) ((DateTime) obj).Ticks;
        this.m_data1 = (int) num;
        this.m_data2 = (int) (num >> 32);
      }
      ...
      else
      {
        ...
        if (varEnum == VarEnum.VT_EMPTY)
          return;
        this.m_flags = this.m_flags | (int) varEnum << 24;
      }
    }
